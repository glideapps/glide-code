...
skills: glide, data-modeling, computed-columns, layout, workflows, app-sharing, api, ai
---
...
- Make modifications (use `build` agent)
- Import more data (use `data` agent)
- Improve the design (use `design` skill for guidance on layouts, components, and collection styles)
