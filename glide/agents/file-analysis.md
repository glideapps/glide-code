...
The builder agent may provide hints about what the user wants:
...
5. **Create a specification** - clear import plan for the builder agent

## Your Key Outputs

The builder agent needs three things from you:
...
After analysis, create a clear specification focused on what the builder needs:
...
Hand off to the **builder agent** with your specification. The builder will:
